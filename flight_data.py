...
def find_cheapest_flight(data, return_date):
    ...
    cheapest_flight = FlightData(lowest_price, departure_airport, destination_airport, departure_date, return_date)
    ...
    for fly in total_flights:
        ...
        if price < lowest_price:
            ...
            destination_airport = fly["flights"][0]["arrival_airport"]["id"]
